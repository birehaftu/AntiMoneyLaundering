<%@ Page Title="Log In" Language="C#" MasterPageFile="~/View/Front.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="AntiLaundering.View.Account.Login" %>
                ...
                <asp:Login ID="LoginUser" runat="server" EnableViewState="true"
                    ...
                    <LayoutTemplate>
                        ...
                        <asp:Panel ID="pnlDefaultButton"  style="align-content:center"  runat="server" DefaultButton="LoginButton">
                            ...
                            <h1 style="text-align:center;color:#080669;font-size:xx-large" >
                         ACT Detecting Money Laundering <br />
                           SIGN IN
                            ...
                            <p class="auto-style4">
                            <asp:Button ID="LoginButton" BackColor="#080669" Font-Size="Medium" Font-Bold="true" runat="server" ForeColor="White" CommandName="Login" Text="Log In      "
