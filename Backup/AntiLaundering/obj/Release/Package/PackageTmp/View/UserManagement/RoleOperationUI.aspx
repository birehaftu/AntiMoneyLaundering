<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site.Master" AutoEventWireup="true" CodeBehind="RoleOperationUI.aspx.cs" Inherits="CBEBirrManage.View.UserManagement.RoleOperationUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ObjectDataSource ID="ModuleDS" runat="server" SelectMethod="getModueses"
        TypeName="CBEBirrManage.Control.UserManagement.ModulesLists"></asp:ObjectDataSource>
</asp:Content>
