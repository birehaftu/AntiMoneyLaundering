...
namespace AntiLaundering.Control.AntiLaundering
{
    public class BlackMarketRateManagement
    {
        ...
        public Boolean InsertBlackMarketRate(Guid BlackMarketRateID, String ExchangeName, String ExchangeCode, String Country,
            DateTime RateDate, Decimal RateAmountInBirr, Decimal BankRate, String RecorderBy, DateTime RecordedDate)
        {
            try
            {
        ...
        {
            var comp_data = (from v in CBE.BlackMarketRates orderby v.ExchangeCode ascending select v).ToList();
            return comp_data;
        }
