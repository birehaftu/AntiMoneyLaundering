...
{
    public partial class CustomerTransactionBalckClassification : System.Web.UI.Page
    {
        ...
        private void AccesCheck()
        {
            ...
            int? accessLevel = isInRole.GetAccessLeve("~/View/AntiLaundering/CustomerTransactionBalckClassification.aspx", User.Identity.Name);
        ...
        {
            FraudDetectedBlackManagement com = new FraudDetectedBlackManagement();
