...
{
    public partial class TrendAnalyzedAugSep : System.Web.UI.Page
    {
        ...
        private void AccesCheck()
        {
            ...
            int? accessLevel = isInRole.GetAccessLeve("~/View/AntiLaundering/TrendAnalyzedAugSep.aspx", User.Identity.Name);
        ...
        {
            FraudDetectedTrendManagement com = new FraudDetectedTrendManagement();
