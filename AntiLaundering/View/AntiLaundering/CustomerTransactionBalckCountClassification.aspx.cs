...
{
    public partial class CustomerTransactionBalckCountClassification : System.Web.UI.Page
    {
        ...
        private void AccesCheck()
        {
            ...
            int? accessLevel = isInRole.GetAccessLeve("~/View/AntiLaundering/CustomerTransactionBalckCountClassification.aspx", User.Identity.Name);
        ...
        {
            FraudDetectedBlackCountManagement com = new FraudDetectedBlackCountManagement();
