                    ...
                    <table>
                        ...
                        <tr id="Tr3" runat="server">
                            <td align="left" class="auto-style6">
                                Device IP</td>
                            <td align="left" class="auto-style4">
                                <asp:TextBox ID="txtPalmIP" Width="160px" runat="server"
                                    meta:resourcekey="txtPalmIPResource1"></asp:TextBox>

                                <asp:RegularExpressionValidator ID="regexpNametxtPalmIP" runat="server"     
                                ErrorMessage="This expression does not validate." 
                                ControlToValidate="txtPalmIP"       ForeColor="Red"
