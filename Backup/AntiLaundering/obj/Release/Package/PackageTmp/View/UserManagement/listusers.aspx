<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/View/Site.Master" CodeBehind="listusers.aspx.cs" Inherits="CBEBirrManage.View.UserManagement.listusers" %>
...
&nbsp;
     <telerik:RadGrid ID="RadGridUsers" runat="server" Width="100%" 
                        ...
                        ondeletecommand="RadGridUsers_DeleteCommand" GridLines="None"  PageSize="20" AllowPaging="true" AllowSorting="true"
                        ...
                        <GroupingSettings CaseSensitive="false" /><MasterTableView AutoGenerateColumns="False" AllowFilteringByColumn="True" 
                          ...
                          <telerik:GridBoundColumn DataField="Email" UniqueName="Email" HeaderText="Email" SortExpression="Email"  AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"  ShowFilterIcon="false"  AllowFiltering="true"  
                                  Visible="true"/>
                              <telerik:GridBoundColumn DataField="EmployeeId" UniqueName="EmployeeId" SortExpression="EmployeeId" HeaderText="Employee Id"  AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"  ShowFilterIcon="false"  AllowFiltering="true"  
                                  Visible="true"/>
