...
{
    public partial class TrendAnalyzedAugSepAND : System.Web.UI.Page
    {
        ...
        private void AccesCheck()
        {
            ...
            int? accessLevel = isInRole.GetAccessLeve("~/View/AntiLaundering/TrendAnalyzedAugSepAND.aspx", User.Identity.Name);
        ...
        {
            FraudDetectedTrendANDManagement com = new FraudDetectedTrendANDManagement();
