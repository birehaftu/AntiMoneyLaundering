<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site.Master" AutoEventWireup="true" CodeBehind="UserLogInReportUI.aspx.cs" Inherits="AntiLaundering.View.Reports.ReportManagement.UserLogInReportUI" %>
...
<%@ Register Assembly="Telerik.ReportViewer.WebForms, Version=13.2.19.1030, Culture=neutral, PublicKeyToken=a9d7983dfcc261be" Namespace="Telerik.ReportViewer.WebForms" TagPrefix="telerikview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: #F6F6F6">
        <telerikview:ReportViewer ID="ReportViewerActionLog" runat="server" Width="1044px" Height="699px" ></telerikview:ReportViewer>
    </div>
</asp:Content>
