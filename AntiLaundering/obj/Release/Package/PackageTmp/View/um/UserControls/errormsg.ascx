<%@ Control Language="C#" AutoEventWireup="true" Inherits="errormsg" CodeBehind="errormsg.ascx.cs" %>
...
<div id="divFade" runat="server" class="divProcess" 
    ...
    border: 1px solid #FF0000; font-family: 'times New Roman', Times, serif; color: #550000;
