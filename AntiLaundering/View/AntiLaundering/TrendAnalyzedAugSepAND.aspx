<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/View/Site.Master" CodeBehind="TrendAnalyzedAugSepANDAND.aspx.cs" Inherits="AntiLaundering.View.AntiLaundering.TrendAnalyzedAugSepAND" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="InputPanel" >
        ...
        <fieldset id="Fieldset1">    
                <asp:Label ID="lbltext" Text=" Customers Classified Trended by AND Operator" runat="server"></asp:Label>
        </fieldset>
    </div>
    <div class="InputPanel" >
