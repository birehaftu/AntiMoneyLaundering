<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditUser.ascx.cs" Inherits="CBEBirrManage.View.UserManagement.EditUser" %>
            ...
            <table>
               ...
               <%-- <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="PalmIPRequired" runat="server"
                            ControlToValidate="txtPalmIP" ErrorMessage="PalmIP is required." ToolTip="PalmIP is required."
                            ValidationGroup="RegisterUserValidationGroup"
                            meta:resourcekey="PalmIPRequiredResource1">*</asp:RequiredFieldValidator>
                    </td>
                </tr>--%>
                <tr>
                    <%--<td>
